...
import javax.swing.JOptionPane;
    ...
    private Pasien validasi() throws ArithmeticException, NumberFormatException{
        ...
        if(txtnorj.getText().equals("")){
           throw new ArithmeticException();
       }
        else{
           data.setNik(txtnorj.getText());
        }
        return data;
    }
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addComponent(SearchButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 106, Short.MAX_VALUE)
        );
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtnorj, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(375, 375, 375)
    ...
    private void SearchButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SearchButtonMouseClicked
        try{
            objek = validasi();
            objek = DBPasien.search(Integer.parseInt(txtnorj.getText()));
            JOptionPane.showMessageDialog(null,"Data Sudah Ditemukan","Information",JOptionPane.INFORMATION_MESSAGE);
            dispose();
            new TampilCariData(objek).setVisible(true);       
        }catch(SQLException err){
            JOptionPane.showMessageDialog(this, "Data Tidak Ditemukan", "Database Error", JOptionPane.ERROR_MESSAGE);
